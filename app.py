...
# Adicionar Transação
    ...
    with st.form("add_transaction"):
        ...
        with col2:
            receiver = st.text_input("Destinatário", placeholder="Ex: Ricardo")
...
# Minerar Bloco
    ...
    if stats['pending_transactions'] == 0:
        ...
        if st.button("Minerar Bloco"):
            if miner_address:
                try:
                    with st.spinner("Minerando bloco..."):
        ...
        try:
            ...
            if start_timestamp >= end_timestamp:
                ...
                if results:
                    ...
                    st.warning("Nenhuma transação encontrada no período especificado.")
        except Exception as e:
            st.error(f"Erro na busca: {str(e)}")
...
# Consultar Saldo
    ...
    address = st.text_input("Endereço", placeholder="Ex: Alice")
